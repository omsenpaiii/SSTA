...
export function Chatbot() {
  ...
  const initializeWelcome = (): ChatMessage => {
    return {
      role: "assistant",
      content: "Hello! I am SSTA AI, your training pathway advisor. Ask me anything about our Security, First Aid, Safety, or Business courses!",
  ...
  const [messages, setMessages] = useState<ChatMessage[]>(() => {
    ...
    const storedChat = window.localStorage.getItem("ssta_chat_history");
    if (storedChat) {
      try {
  ...
  const clearChat = () => {
    if (typeof window !== "undefined") {
      window.localStorage.removeItem("ssta_chat_history");
    }
    resetToWelcome();
  };
  ...
  const quickSuggestions = [
    { label: "🛡️ Security Operations", query: "Tell me about Security operations courses" },
    { label: "🩹 First Aid Costs", query: "How much do First Aid and CPR courses cost?" },
    { label: "✍️ How to Enrol", query: "How do I enrol in a course?" },
    { label: "🚀 Coming Soon", query: "What qualifications are coming soon?" },
  ];
          ...
          >
            ...
            <div className="bg-gradient-to-r from-[#020d24] via-[#0067b1] to-[#020d24] px-5 py-4 flex items-center justify-between text-white border-b border-[#18aee5]/12">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <h3 className="text-sm font-black tracking-wide">SSTA AI Assistant</h3>
            ...
            >
              <input
                ...
                placeholder="Ask about SSTA courses..."

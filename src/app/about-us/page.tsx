...
import { benefits, siteInfo } from "@/lib/site-content";
        ...
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
          <div>
            ...
            <h1 className="text-5xl font-black leading-tight tracking-normal sm:text-6xl">
              Practical training for confident security careers.
            </h1>
            <p className="mt-5 text-lg font-bold leading-8 text-[#53647c]">
              {siteInfo.name} presents security, first aid and workplace safety learning in a clear,
              student-first format: transparent course details, preview lessons and a simple enrolment flow.
            </p>
          ...
          <div className="relative h-[420px] overflow-hidden rounded-[1.5rem] border-[10px] border-white shadow-[0_30px_90px_rgba(0,74,143,0.14)]">
            <Image
              ...
              alt="Students discussing training"
              fill

...
function buildResources(course: Course): StudentResource[] {
  const resources: StudentResource[] = [
    ...
    },
    {
      ...
      description: course.deliveryModes.join(" • ") || "Delivery details will be confirmed by SSTA.",
      kind: "info",
    },
    {
...
export function buildVerifyCertificateSteps() {
  return [
    ...
    "Email SSTA support or call the academy so the team can validate the record quickly.",
  ...
  return [
    {
      ...
      description: "Start with SSTA support when you need policy guidance, learning clarity, or next-step help.",
      href: "/contact",
      actionLabel: "Open support",
    },
    {
      title: "Course catalogue",
      description: "Browse current SSTA programs and compare delivery pathways.",
      href: "/dashboard/browse-courses",
      actionLabel: "Browse courses",
    },
    {
      title: "Need enrolment support?",
      description: "Reach the SSTA team for scheduling, access, or progression questions.",
